...
`;var m=document.getElementById("theme-toggle-dark-icon"),g=document.getElementById("theme-toggle-light-icon");localStorage.getItem("color-theme")==="dark"||!("color-theme"in localStorage)&&window.matchMedia("(prefers-color-scheme: dark)").matches?g.classList.remove("hidden"):m.classList.remove("hidden");var w=document.getElementById("theme-toggle");w.addEventListener("click",function(){m.classList.toggle("hidden"),g.classList.toggle("hidden"),localStorage.getItem("color-theme")?localStorage.getItem("color-theme")==="light"?(document.documentElement.classList.add("dark"),localStorage.setItem("color-theme","dark")):(document.documentElement.classList.remove("dark"),localStorage.setItem("color-theme","light")):document.documentElement.classList.contains("dark")?(document.documentElement.classList.remove("dark"),localStorage.setItem("color-theme","light")):(document.documentElement.classList.add("dark"),localStorage.setItem("color-theme","dark"))});new b("#typed",{stringsElement:"#typed-strings",backSpeed:40,typeSpeed:60});const x=document.getElementById("toggle-menu-button"),y=document.getElementById("menu");x.addEventListener("click",()=>{y.classList.toggle("hidden")});
